              ...
              <form class="card-body">
                ...
                <div class="row g-3">
                  <div class="col-md-6">
                    ...
                    <input type="text" id="multicol-username" class="form-control" placeholder="جون سميث" />
                  </div>
                  <div class="col-md-6">
                    <label class="form-label" for="multicol-email">Email</label>
                    <div class="input-group input-group-merge">
                      <input type="text" id="multicol-email" class="form-control" placeholder="جون سميث" aria-label="john.doe" aria-describedby="multicol-email2" />
