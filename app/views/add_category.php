    ...
    <div class="layout-container">
      ...
      <div class="content-wrapper">
        ...
        <div class="container-xxl flex-grow-1 container-p-y">
          <h4 class="fw-bold py-3 mb-4"><span class="text-muted"> اضافة </span> قسم جديد </h4>
            ...
            <form class="card-body" action="/save_category" method="POST" enctype="multipart/form-data">
              ...
              <div class="row g-3">
                <div class="col-md-6">
                  ...
                  <input name="category_name" type="text" id="multicol-username" class="form-control" placeholder="جون سميث" />
                </div>
                <div class="col-md-6">
